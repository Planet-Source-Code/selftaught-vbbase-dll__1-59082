...
Private Sub cmd_Click(Index As Integer)
    ...
    Case cmdEnumSubclasses
        ...
        For Each loSub In Subclasses(Me)
            lsMsg = lsMsg & FmtHex(loSub.hWnd) & vbTab & ClassName(loSub.hWnd) & vbNewLine
        Next
        MsgBox lsMsg
    End Select
...
Private Sub Form_Load()
  ...
  Dim s As String
    ...
    lbl(lblHeader).Caption = "######## When.. lReturn. hWnd.... uMsg.... wParam.. lParam.. Message name....... "
...
Private Sub Form_Resize()
  On Error Resume Next
    ...
    liOffset = pic(picHeader2).Top + pic(picHeader2).Height
